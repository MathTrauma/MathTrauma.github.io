...
if (window.innerWidth < 768) {
    ...
    controls.target.set(-0.08206262548844094, 3.3119233527087255, -0.7433922282864018);
} else {
    camera.position.set(17.49173098423395, 9.108969527553887, 17.850992894238058);
    controls.target.set(0.4624746759408973, 1.9719940043010387, -0.8300979125494505);
}
...
manager.onLoad = function () {
    ...
    function handleEnter() {
        ...
        loadingScreenButton.textContent = "~ Welcome to Chaos Academy! ~";
...
let C1_Key, Cs1_Key, D1_Key, Ds1_Key,
E1_Key, F1_Key, Fs1_Key,
G1_Key, Gs1_Key,
A1_Key, As1_Key, B1_Key;
